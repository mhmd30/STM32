...
# 110 "./mcc_generated_files/examples/../pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 122 "./mcc_generated_files/examples/../pin_manager.h"
...
# 132 "./mcc_generated_files/examples/../interrupt_manager.h"
...
# 125 "./mcc_generated_files/examples/../memory.h"
uint16_t FLASH_ReadWord(uint32_t flashAddr);
# 157 "./mcc_generated_files/examples/../memory.h"
void FLASH_WriteByte(uint32_t flashAddr, uint8_t *flashRdBufPtr, uint8_t byte);
# 193 "./mcc_generated_files/examples/../memory.h"
int8_t FLASH_WriteBlock(uint32_t writeAddr, uint8_t *flashWrBufPtr);
# 218 "./mcc_generated_files/examples/../memory.h"
void FLASH_EraseBlock(uint32_t baseAddr);
# 249 "./mcc_generated_files/examples/../memory.h"
void DATAEE_WriteByte(uint16_t bAdd, uint8_t bData);
# 275 "./mcc_generated_files/examples/../memory.h"
uint8_t DATAEE_ReadByte(uint16_t bAdd);

void MEMORY_Tasks(void);
# 57 "./mcc_generated_files/mcc.h" 2

# 1 "./mcc_generated_files/examples/../eusart.h" 1
# 75 "./mcc_generated_files/examples/../eusart.h"
typedef union {
    struct {
        unsigned perr : 1;
        unsigned ferr : 1;
...
# 110 "./mcc_generated_files/examples/../eusart.h"
void EUSART_Initialize(void);
# 158 "./mcc_generated_files/examples/../eusart.h"
_Bool EUSART_is_tx_ready(void);
# 206 "./mcc_generated_files/examples/../eusart.h"
_Bool EUSART_is_rx_ready(void);
# 253 "./mcc_generated_files/examples/../eusart.h"
_Bool EUSART_is_tx_done(void);
# 301 "./mcc_generated_files/examples/../eusart.h"
eusart_status_t EUSART_get_last_status(void);
# 321 "./mcc_generated_files/examples/../eusart.h"
uint8_t EUSART_Read(void);
# 341 "./mcc_generated_files/examples/../eusart.h"
void EUSART_Write(uint8_t txData);
# 361 "./mcc_generated_files/examples/../eusart.h"
void EUSART_SetFramingErrorHandler(void (* interruptHandler)(void));
# 379 "./mcc_generated_files/examples/../eusart.h"
void EUSART_SetOverrunErrorHandler(void (* interruptHandler)(void));
# 397 "./mcc_generated_files/examples/../eusart.h"
...
# 12 "./AECUL_Modules/RealTimeClockDS1307/RealTimeClockDS1307.h"
...
# 12 "./AECUL_Modules/EEPROM_24C02C/EEPROM_24C02C.h"
...
# 13 "./AECUL_Modules/TemSensor_TC74/TemSensor_TC74.h"
