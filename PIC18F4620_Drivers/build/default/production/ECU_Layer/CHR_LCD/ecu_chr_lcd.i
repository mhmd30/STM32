...
# 14 "ECU_Layer/CHR_LCD/ecu_chr_lcd.h"
...
# 15 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/../std_libraries.h" 1
# 15 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 17 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 15 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/../compiler.h" 2
# 16 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 30 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 71 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 17 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 45 "ECU_Layer/CHR_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 1 "ECU_Layer/CHR_LCD/ecu_chr_lcd_custom_chr.h" 1
# 31 "ECU_Layer/CHR_LCD/ecu_chr_lcd_custom_chr.h"
...
# 16 "ECU_Layer/CHR_LCD/ecu_chr_lcd.h" 2
...
# 23 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_intialize(const chr_lcd_4bit_t *lcd){
...
# 60 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_command(const chr_lcd_4bit_t *lcd, uint8 command){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 89 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_char_data(const chr_lcd_4bit_t *lcd, uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 120 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_char_data_pos(const chr_lcd_4bit_t *lcd,uint8 row, uint8 column, uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 140 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_string(const chr_lcd_4bit_t *lcd, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 163 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_string_pos(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 188 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column,
                                         const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 lcd_counter = 0;
...
# 212 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_intialize(const chr_lcd_8bit_t *lcd){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_data_pins_counter = 0;
    if(((void*)0) == lcd){
...
# 249 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_command(const chr_lcd_8bit_t *lcd, uint8 command){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 277 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd, uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_pin_counter = 0;
    if(((void*)0) == lcd){
...
# 307 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_char_data_pos(const chr_lcd_8bit_t *lcd,uint8 row, uint8 column, uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 327 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_string(const chr_lcd_8bit_t *lcd, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 350 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_string_pos(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 373 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column,
                                         const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 lcd_counter = 0;
...
# 398 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint8_to_string(uint8 value, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == str){
        ret = (Std_ReturnType)0x00;
...
# 418 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint16_to_string(uint16 value, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 445 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint32_to_string(uint32 value, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == str){
        ret = (Std_ReturnType)0x00;
...
# 465 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_send_4bits(const chr_lcd_4bit_t *lcd, uint8 _data_command){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 481 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_4bit_send_enable_signal(const chr_lcd_4bit_t *lcd){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 496 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_8bit_send_enable_signal(const chr_lcd_8bit_t *lcd){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    ret = gpio_pin_write_logic(&(lcd->lcd_en), GPIO_HIGH);
    _delay((unsigned long)((5)*(8000000UL/4000000.0)));
...
# 513 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 coulmn){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    coulmn--;
    switch(row){
...
# 535 "ECU_Layer/CHR_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 coulmn){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    coulmn--;
    switch(row){
...
void LCD_Send_Number(const chr_lcd_8bit_t *lcd , uint8 num)
{
 uint8 arr[10],i=0,j=0;
  ...
  else
  {
   ...
   for(j=i;j>0;j--)
   {
    lcd_8bit_send_char_data(lcd ,arr[j-1]);
            }
  }
}
...
Std_ReturnType display_num_on_lcd(const chr_lcd_8bit_t *lcd, uint8 num)
{
    ...
    char num_str[2];
    convert_uint8_to_string(num, (uint8*)num_str);
    lcd_8bit_send_char_data(lcd, num_str[0]);
    }
    return ret;
}
...
Std_ReturnType display_op_on_lcd(const chr_lcd_8bit_t *lcd, char op)
{
    ...
    lcd_8bit_send_char_data(lcd, op);
    }
    return ret;
}
