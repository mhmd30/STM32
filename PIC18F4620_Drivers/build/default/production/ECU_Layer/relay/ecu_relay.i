...
# 15 "ECU_Layer/relay/ecu_relay.h"
...
# 15 "ECU_Layer/relay/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "ECU_Layer/relay/../../MCAL_Layer/GPIO/../std_libraries.h" 1
# 15 "ECU_Layer/relay/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 17 "ECU_Layer/relay/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 15 "ECU_Layer/relay/../../MCAL_Layer/GPIO/../compiler.h" 2
# 16 "ECU_Layer/relay/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 30 "ECU_Layer/relay/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 71 "ECU_Layer/relay/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 17 "ECU_Layer/relay/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 45 "ECU_Layer/relay/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 15 "ECU_Layer/relay/ecu_relay.h" 2

# 1 "ECU_Layer/relay/../ecu_relay_cfg.h" 1
# 16 "ECU_Layer/relay/ecu_relay.h" 2
# 33 "ECU_Layer/relay/ecu_relay.h"
typedef struct{
    uint8 relay_port :4;
    uint8 relay_pin :3;
...
# 20 "ECU_Layer/relay/ecu_relay.c"
Std_ReturnType relay_initialize(const relay_t *_relay){
...
# 60 "ECU_Layer/relay/ecu_relay.c"
Std_ReturnType relay_turn_off(const relay_t *_relay){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _relay){
        ret = (Std_ReturnType)0x00;
...
Std_ReturnType relay_toggle(relay_t *_relay){
 Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _relay){
        ...
        if(0x01U == _relay->relay_status){
            gpio_pin_write_logic(&pin_obj , GPIO_LOW);
            _relay->relay_status = 0x00U;
        }
        else{
            gpio_pin_write_logic(&pin_obj , GPIO_HIGH);
            _relay->relay_status = 0x01U;
        }
